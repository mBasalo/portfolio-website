...
<h1><AnchorLink className='anchor-link' offset={200} href='#home'><p onClick={() => setMenu("home")}>mBasalo</p><></></AnchorLink></h1>
<img className='nav-mob-open' src={menu_open} onClick={openMenu} alt="" />
        ...
        <ul ref={menuRef} className="nav-menu">
          <img src={menu_close} alt="" className="nav-mob-close" onClick={closeMenu}/>
            ...
            <li><AnchorLink className='anchor-link' offset={10} href='#work'><p onClick={() => setMenu("work")}>Portfolio</p>{menu === "work"?<img src={underline} alt=''/>:<></>}</AnchorLink></li>
